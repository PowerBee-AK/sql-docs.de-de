...
:::row:::
    ...
    :::column-end:::
    :::column:::
        [SQL-Datenbank](alter-login-transact-sql.md?view=azuresqldb-current&preserve-view=true)
    :::column-end:::
    :::column:::
...
**Gilt für:** [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] und höher sowie für Azure SQL Managed Instance.
