...
**Gilt für:** [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] bis zur [aktuellen Version](/troubleshoot/sql/general/determine-version-edition-update-level) und für Azure SQL Managed Instance
