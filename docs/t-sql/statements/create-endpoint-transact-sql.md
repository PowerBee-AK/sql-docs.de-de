 ...
 **AES**  
 Gibt an, dass der Endpunkt den AES-Algorithmus verwenden muss. In [!INCLUDE[sssql16-md](../../includes/sssql16-md.md)] und höher ist dies die Standardeinstellung.  
