...
Für nativ kompilierte gespeicherte Prozeduren, die mit [!INCLUDE[sssql16-md](../../includes/sssql16-md.md)] und [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)] beginnen, bestehen keine Einschränkungen für die EXECUTE AS-Klausel. In [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] werden die SELF-, OWNER- und *'user_name'* -Klauseln bei nativ kompilierten gespeicherten Prozeduren unterstützt.
