...
##  <a name="converting-date-and-time-data"></a><a name="_datetime"></a> Konvertieren von Datums- und Zeitdaten  
...
Beim Konvertieren von **date** werden das Jahr, der Monat und der Tag kopiert. Die Zeitkomponente wird auf 00:00:00.000 festgelegt. Der folgende Code zeigt die Ergebnisse der Konvertierung eines `date`-Werts in einen `datetime`-Wert.  
