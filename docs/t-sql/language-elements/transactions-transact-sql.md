...
> [!NOTE] 
> Besondere Aspekte im Zusammenhang mit Data Warehouse-Produkten finden Sie unter [Transaktionen (Azure Synapse Analytics)](transactions-sql-data-warehouse.md).   
