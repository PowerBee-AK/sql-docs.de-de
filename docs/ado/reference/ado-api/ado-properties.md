...
|[Textmarke](./bookmark-property-ado.md)|Gibt ein Lesezeichen an, das den aktuellen Datensatz in einem **Recordset** -Objekt eindeutig identifiziert, oder legt den aktuellen Datensatz in einem **Recordset** -Objekt auf den Datensatz fest, der durch ein gültiges Lesezeichen identifiziert wird.|  
