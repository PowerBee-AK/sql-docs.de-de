---
description: Append- und CreateParameter-Methode – Beispiel (VB)
title: Beispiel für Append und die Methode "Anfüge Parameter" (VB) | Microsoft-Dokumentation
ms.prod: sql
