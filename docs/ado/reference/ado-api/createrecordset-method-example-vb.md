---
description: CreateRecordset-Methode – Beispiel (VB)
title: Beispiel für die Methode "kreaterecordset" (VB) | Microsoft-Dokumentation
ms.prod: sql
...
ms.locfileid: "100034581"
---
# <a name="createrecordset-method-example-vb"></a>CreateRecordset-Methode – Beispiel (VB)
Sie können ein [Recordset](./recordset-object-ado.md) -Objekt erstellen und die Spalten Informationen angeben. Anschließend können Sie Daten in das **Recordset** -Objekt einfügen. das zugrunde liegende Rowset puffert die Einfügungen.  
  
 Im folgenden Codebeispiel wird gezeigt, wie ein **Recordset** mit dem [RDSServer. DataFactory](../rds-api/datafactory-object-rdsserver.md) -Objekt definiert wird. Sie können dies auch mit RDS tun [. DataControl](../rds-api/datacontrol-object-rds.md) -Objekt.  
