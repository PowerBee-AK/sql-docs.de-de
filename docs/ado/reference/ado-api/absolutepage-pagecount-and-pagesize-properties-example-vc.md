...
In diesem Beispiel werden die Eigenschaften " [AbsolutePage](./absolutepage-property-ado.md)", " [PageCount](./pagecount-property-ado.md)" und " [PageSize](./pagesize-property-ado.md) " verwendet, um Namen und Einstellungsdaten aus der ***Employee** _-Tabelle, fünf Datensätze gleichzeitig anzuzeigen.  
