---
description: Beispiel für AbsolutePage, PageCount und pageSize-Eigenschaften (VB)
title: Beispiel für AbsolutePage, PageCount und pageSize-Eigenschaften (VB) | Microsoft-Dokumentation
ms.prod: sql
