---
description: UpdateBatch- und CancelBatch-Methode – Beispiel (VC++)
title: Beispiel für UpdateBatch und CancelBatch-Methoden (VC + +) | Microsoft-Dokumentation
ms.prod: sql
