---
description: Type-Eigenschaft – Beispiel (Field) (VC++)
...
ms.locfileid: "100056415"
---
# <a name="type-property-example-field-vc"></a>Type-Eigenschaft – Beispiel (Field) (VC++)
In diesem Beispiel wird die [Type](./type-property-ado.md) -Eigenschaft veranschaulicht, indem der Name der Konstante angezeigt wird, die dem Wert der **Type** -Eigenschaft aller [Feld](./field-object.md) Objekte in der **_Employees_** -Tabelle entspricht. Die FieldType-Funktion ist erforderlich, damit diese Prozedur ausgeführt werden kann.  
