---
description: CreateRecordset-Methode – Beispiel (VBScript)
title: Beispiel für die Methode "kreaterecordset" (VBScript) | Microsoft-Dokumentation
ms.prod: sql
