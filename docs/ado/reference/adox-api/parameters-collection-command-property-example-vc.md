---
description: Parameters-Collection, Command-Eigenschaft – Beispiel (VC++)
title: Parameter Auflistung, Beispiel für Befehls Eigenschaft (VC + +) | Microsoft-Dokumentation
ms.prod: sql
