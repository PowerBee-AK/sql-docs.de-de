---
description: GetPermissions- und SetPermissions-Methoden – Beispiel (VC++)
title: Getberechtigungs-und setberechtigungs-Methoden Beispiel (VC + +) | Microsoft-Dokumentation
ms.prod: sql
