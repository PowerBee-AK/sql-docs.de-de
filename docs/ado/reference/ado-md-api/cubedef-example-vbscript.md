---
description: CubeDef-Beispiel (VBScript)
title: CubeDef-Beispiel (VBScript) | Microsoft-Dokumentation
ms.prod: sql
...
ms.locfileid: "100054825"
---
# <a name="cubedef-example-vbscript"></a>CubeDef-Beispiel (VBScript)
In diesem Beispiel werden die Cube-Metadaten auf einer Webseite angezeigt.  
