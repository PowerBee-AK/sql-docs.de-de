...
> [!NOTE]  
> Die Ressourcenkontrolle erstellt den "Standard" und interne Gruppen, wenn [!INCLUDE[ssNoVersion](ssnoversion-md.md)] installiert ist.  
...
> [!NOTE]  
> Der Istwert, den der [!INCLUDE[ssDE](ssde-md.md)] für MAX_DOP festlegt, ist möglicherweise kleiner als der angegebene Wert. Der endgültige Wert wird von Formel min(255, *number of CPUs)* bestimmt.  
