---
description: getTimestamp-Methode (int, java.util.Calendar) (SQLServerResultSet)
title: Methode „getTimestamp(int, java.util.Calendar)“ (SQLServerResultSet) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
