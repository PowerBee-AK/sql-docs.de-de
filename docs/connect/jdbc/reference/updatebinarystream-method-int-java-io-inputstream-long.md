---
description: updateBinaryStream-Methode (int, java.io.InputStream, long)
title: updateBinaryStream-Methode (int, java.io.InputStream, long) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
