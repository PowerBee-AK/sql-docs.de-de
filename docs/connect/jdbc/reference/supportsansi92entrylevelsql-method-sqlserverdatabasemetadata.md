---
description: supportsANSI92EntryLevelSQL-Methode (SQLServerDatabaseMetaData)
title: supportsANSI92EntryLevelSQL-Methode (SQLServerDatabaseMetaData) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
