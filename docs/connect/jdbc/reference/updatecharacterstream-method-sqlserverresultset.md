---
description: updateCharacterStream-Methode (SQLServerResultSet)
title: Microsoft-DokumentationupdateCharacterStream-Methode (java.io.Reader, int) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
