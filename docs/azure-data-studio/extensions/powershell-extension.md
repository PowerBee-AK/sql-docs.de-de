...
Sie können das offizielle Release der PowerShell-Erweiterung installieren, indem Sie die Schritte in der [Azure Data Studio](./add-extensions.md)-Dokumentation ausführen.
