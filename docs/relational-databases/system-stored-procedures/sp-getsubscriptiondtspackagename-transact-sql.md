...
`[ @publication = ] 'publication'` Der Name der Veröffentlichung. **'**_Publication_*_'_* ist vom **Datentyp vom Datentyp sysname** und hat keinen Standardwert.  
