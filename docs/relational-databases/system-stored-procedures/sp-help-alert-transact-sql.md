...
|**performance_condition**|**nvarchar(512)**|Wenn  der Typ **2** ist, wird in dieser Spalte die Definition der Leistungs Bedingung angezeigt. Andernfalls ist die Spalte NULL.|  
