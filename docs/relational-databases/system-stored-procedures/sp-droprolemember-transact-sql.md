...
### <a name="syntax-for-both-azure-synapse-analytics-and-parallel-data-warehouse"></a>Syntax für Azure Synapse Analytics und parallel Data Warehouse
