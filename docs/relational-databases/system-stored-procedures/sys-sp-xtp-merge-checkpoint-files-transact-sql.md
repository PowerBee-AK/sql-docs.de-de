...
||  
|-|  
|**Hinweis**: Diese gespeicherte Prozedur ist in veraltet [!INCLUDE[sssql16-md](../../includes/sssql16-md.md)] . Er wird nicht mehr benötigt und kann nicht verwendet werden, da er gestartet wird [!INCLUDE[sssql16-md](../../includes/sssql16-md.md)] .|  
