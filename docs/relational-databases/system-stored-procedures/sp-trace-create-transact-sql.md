 ...
 **sp_trace_create** ist eine [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] gespeicherte Prozedur, die viele der zuvor von **xp_trace_ \* *_ erweiterten gespeicherten Prozeduren ausgeführten Aktionen ausführt, die in früheren Versionen von SQL Server verfügbar waren. Verwenden Sie _* sp_trace_create** anstelle von:  
