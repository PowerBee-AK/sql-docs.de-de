---
description: Gespeicherte Prozeduren des SQL Server-Agents (Transact-SQL)
title: SQL Server-Agent gespeicherter Prozeduren (Transact-SQL) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
