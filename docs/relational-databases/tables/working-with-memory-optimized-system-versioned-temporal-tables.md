...
> [!NOTE]
> Das Verwenden von temporalen mit speicheroptimierten Tabellen gilt nur für [!INCLUDE[ssnoversion](../../includes/ssnoversion-md.md)] , und nicht für [!INCLUDE[sqldbesa](../../includes/sqldbesa-md.md)].
