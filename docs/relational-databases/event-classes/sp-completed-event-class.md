---
description: SP:Completed-Ereignisklasse
...
|ObjektType|**int**|Typ der aufgerufenen gespeicherten Prozedur. Dieser Wert entspricht der type-Spalte in der sys.objects-Katalogsicht. Weitere Werte finden Sie unter [ObjectType (Spalte für Ablaufverfolgungsereignisse)](../../relational-databases/event-classes/objecttype-trace-event-column.md).|28|Ja|  
