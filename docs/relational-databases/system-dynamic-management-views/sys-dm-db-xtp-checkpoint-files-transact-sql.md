...
##  <a name="sssql16-md-and-later"></a><a name="bkmk_2016"></a> [!INCLUDE[sssql16-md](../../includes/sssql16-md.md)] und höher  
 In der folgenden Tabelle werden die Spalten für `sys.dm_db_xtp_checkpoint_files` , beginnend mit, beschrieben **[!INCLUDE[sssql16-md](../../includes/sssql16-md.md)]** .  
