---
description: Mit der Datenbank verbundene dynamische Verwaltungssichten (Transact-SQL)
title: Datenbankbezogene dynamische Verwaltungs Sichten (Transact-SQL) | Microsoft-Dokumentation
ms.custom: ''
ms.date: 05/18/2017
ms.prod: sql
ms.reviewer: ''
...
[!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]
  ...
  In diesem Abschnitt werden die folgenden dynamischen Verwaltungs Objekte in [!INCLUDE[ssNoVersion_md](../../includes/ssnoversion-md.md)] und manchmal in der SQL-Datenbank beschrieben.  
...
Die für die SQL-Datenbank oder Azure-Synapse-Analyse einzigartige DMV.   
...
:::row:::
    ...
    :::column:::
        ...
        [sys.dm_db_objects_impacted_on_version_change &#40;Azure SQL-Datenbank&#41;](../../relational-databases/system-dynamic-management-views/sys-dm-db-objects-impacted-on-version-change-azure-sql-database.md)
    :::column-end:::
:::row-end:::
