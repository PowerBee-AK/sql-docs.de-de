...
|**logical_device_name**|**nvarchar(256)**|Der vom Benutzer angegebene Name für das Laufwerk (von **sys.backup_devices**). NULL, wenn kein benutzerdefinierter Name verfügbar ist. Lässt NULL-Werte zu.|  
