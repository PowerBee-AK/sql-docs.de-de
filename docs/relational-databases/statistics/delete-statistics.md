...
ms.locfileid: "99250294"
---
# <a name="delete-statistics"></a>Löschen von Statistiken
[!INCLUDE[SQL Server Azure SQL Database Synapse Analytics PDW ](../../includes/applies-to-version/sql-asdb-asdbmi-asa-pdw.md)]
  Statistiken aus Tabellen und Sichten in [!INCLUDE[ssnoversion](../../includes/ssnoversion-md.md)] können Sie löschen mit [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] oder [!INCLUDE[tsql](../../includes/tsql-md.md)]  
