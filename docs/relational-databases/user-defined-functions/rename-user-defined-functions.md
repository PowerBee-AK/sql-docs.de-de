...
ms.locfileid: "99184251"
---
# <a name="rename-user-defined-functions"></a>Umbenennen von benutzerdefinierten Funktionen
[!INCLUDE [SQL Server SQL Database](../../includes/applies-to-version/sql-asdb.md)]
  Sie können benutzerdefinierte Funktionen in [!INCLUDE[ssnoversion](../../includes/ssnoversion-md.md)] mit [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] oder [!INCLUDE[tsql](../../includes/tsql-md.md)]umbenennen.  
