...
ms.locfileid: "99184292"
---
# <a name="delete-user-defined-functions"></a>Löschen von benutzerdefinierten Funktionen
[!INCLUDE [SQL Server SQL Database](../../includes/applies-to-version/sql-asdb.md)]
  Sie können benutzerdefinierte Funktionen in [!INCLUDE[ssnoversion](../../includes/ssnoversion-md.md)] löschen mit [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] oder [!INCLUDE[tsql](../../includes/tsql-md.md)]  
