...
description: Aktivieren Sie FILESTREAM zunächst für die SQL Server-Datenbank-Engine-Instanz, um die Option verwenden zu können. Erfahren Sie, wie Sie FILESTREAM mit dem SQL Server-Konfigurations-Manager aktivieren.
ms.custom: ''
ms.date: 08/23/2017
ms.prod: sql
ms.reviewer: ''
