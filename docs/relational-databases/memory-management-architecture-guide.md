...
description: Informieren Sie sich über die Architektur der Speicherverwaltung in SQL Server sowie über Änderungen an der Speicherverwaltung im Vergleich zu vorherigen Versionen.
ms.custom: ''
ms.date: 01/09/2019
ms.prod: sql
