...
description: Erfahren Sie mehr über eigenständige Datenbanken, die Vorteile und Einschränkungen partiell eigenständiger Datenbanken und darüber, wie SQL Server 2019 Datenbanken isoliert.
ms.custom: ''
ms.date: 08/24/2016
ms.prod: sql
