...
## <a name="always-encrypted-api-reference"></a>Always Encrypted – API-Referenz
...
|:---|:---|:---
|[SqlColumnEncryptionCertificateStoreProvider-Klasse](/dotnet/api/system.data.sqlclient.sqlcolumnencryptioncertificatestoreprovider)|Ein Schlüsselspeicheranbieter für den Windows-Zertifikatspeicher.|  4.6
|[SqlColumnEncryptionCngProvider-Klasse](/dotnet/api/system.data.sqlclient.sqlcolumnencryptioncngprovider)|Eine Schlüsselspeicheranbieter für Microsoft Cryptography API: Next Generation (CNG).|  4.6.1
|[SqlColumnEncryptionCspProvider-Klasse](/dotnet/api/system.data.sqlclient.sqlcolumnencryptioncspprovider)|Eine Schlüsselspeicheranbieter für die auf der Microsoft CAPI basierenden Kryptografiedienstanbieter.|4.6.1  
|[SqlColumnEncryptionKeyStoreProvider](/dotnet/api/system.data.sqlclient.sqlcolumnencryptionkeystoreprovider)|Die Basisklasse der Schlüsselspeicheranbieter.|  4.6
|[SqlCommandColumnEncryptionSetting-Enumeration](/dotnet/api/system.data.sqlclient.sqlcommandcolumnencryptionsetting)|Einstellungen zum Aktivieren der Verschlüsselung und Entschlüsselung für eine Datenbankverbindung.|4.6  
|[SqlConnectionColumnEncryptionSetting-Enumeration](/dotnet/api/system.data.sqlclient.sqlconnectioncolumnencryptionsetting)|Einstellungen zum Steuern des Verhaltens von „Always Encrypted“ für einzelne Abfragen.|4.6  
...
|Neues [Verbindungszeichenfolgen](/dotnet/api/system.data.sqlclient.sqlconnection.connectionstring) -Schlüsselwort: `Column Encryption Setting=enabled`|Aktiviert oder deaktiviert die „Always Encrypted“-Funktionalität für die Verbindung.| 4.6 
