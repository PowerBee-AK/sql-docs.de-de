---
description: Handbuch zur Architektur und Verwaltung von Transaktionsprotokollen in SQL Server
...
[Erläuterungen zu Protokollierung und Wiederherstellung in SQL Server von Paul Randal](/previous-versions/technet-magazine/dd392031(v=msdn.10))    
