...
description: SQL Server verwendet das Standardkomprimierungsschema für Unicode-Algorithmen, um Unicode-Werte zu komprimieren, die in zeilen- oder seitenkomprimierten Objekten gespeichert werden.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
