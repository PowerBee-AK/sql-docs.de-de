---
description: Ändern oder Umbenennen von DML-Triggern
...
ms.locfileid: "99187284"
---
# <a name="modify-or-rename-dml-triggers"></a>Ändern oder Umbenennen von DML-Triggern
[!INCLUDE [SQL Server SQL Database](../../includes/applies-to-version/sql-asdb.md)]
  In diesem Thema wird beschrieben, wie Sie einen DML-Trigger in [!INCLUDE[ssnoversion](../../includes/ssnoversion-md.md)] mithilfe von [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] oder [!INCLUDE[tsql](../../includes/tsql-md.md)]umbenennen.  
