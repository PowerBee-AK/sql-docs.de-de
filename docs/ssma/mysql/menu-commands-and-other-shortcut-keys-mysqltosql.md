---
title: Menübefehle und andere Tastenkombinationen (mysqlto SQL) | Microsoft-Dokumentation
description: Erfahren Sie mehr über Tastenkombinationen für den Zugriff auf Menübefehle und andere Tastenkombinationen, die in den verschiedenen Dialogfeldern der SSMA für MySQL-Anwendung verwendet werden.
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
|Hiermit wird das Dialogfeld Verbindung herstellen oder Verbindung mit MySQL herstellen angezeigt.|Alt + F + T|  
...
|zu diesem Zweck|Drückt|  
|--------------|---------|  
|Anzeigeinformationen zum Dialogfeld SSMA für MySQL.|ALT + H + A|  
...
[Tastenkombinationen &#40;mysqlto SQL&#41;](../../ssma/mysql/shortcut-keys-mysqltosql.md)  
