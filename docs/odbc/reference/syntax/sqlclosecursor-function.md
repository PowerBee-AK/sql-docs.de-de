...
> [!NOTE]  
>  Bei ODBC 3. *x* -Anwendung, die mit ODBC 2 arbeitet. der *x* -Treiber ruft **SQLCloseCursor** auf, wenn kein Cursor geöffnet ist, SQLSTATE 24000 (Ungültiger Cursor Zustand) wird nicht zurückgegeben, da der Treiber-Manager sqlsorsecursor mit SQL_CLOSE zu **SQLFreeStmt** zuordnet.   
